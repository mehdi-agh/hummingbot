...
class msamexExchange(ExchangeBase):
    """
    msamexExchange connects with www.msamex.com exchange and provides order book pricing, user account tracking and
    ...
    def __init__(self,
        ...
        """
        :param msamex_api_key: The API key to connect to private www.msamex.com APIs.
    ...
    async def _execute_cancel(self, trading_pair: str, order_id: str) -> CancellationResult:
        ...
        :param trading_pair: The market trading pair (Unused during cancel on www.msamex.com)
